...
export default function Health() {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Health News" component={News}
        options={{
          title: 'Health News',
          headerStyle: {
...
function News({navigation, route}) {
  ...
  useEffect(()=>{
    ...
    axios.get('https://newsapi.org/v2/top-headlines?country=ph&category=health&apiKey=2ac99f3d1e86434e8ab50bcecf66b135')
